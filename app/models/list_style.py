...
class ListStyle(db.Model):
    ...
    title_color = db.Column(db.String(255), nullable=False, default="#000000")
    ...
    li_color = db.Column(db.String(255), nullable=False, default="#000000")
    ...
    li_completed_color = db.Column(db.String(255), nullable=False, default="#000000")
    li_completed_decoration = db.Column(db.String(255), nullable=False, default="#FF0000")
