...
class ListStyle(db.Model):
    ...
    image_url = db.Column(db.String(255), default="https://i.ibb.co/18vQfvN/Nice-Png-torn-paper-texture-png-455986.png")
    title_font = db.Column(db.String(255), default="Arial")
    title_size = db.Column(db.String(255), default="14pt")
    title_style = db.Column(db.String(255), default="normal")
    title_weight = db.Column(db.String(255), default="bold")
    title_color = db.Column(db.String(255), default="black")
    title_align = db.Column(db.String(255), default="center")
    li_font = db.Column(db.String(255), default="Arial")
    li_size = db.Column(db.String(255), default="12pt")
    li_style = db.Column(db.String(255), default="normal")
