...
def seed_list_styles():
    style_1 = ListStyle(list_id=1, image_url='https://i.ibb.co/MB5XSWX/coding.png', title_font='Times New Roman', title_size='18pt', title_style='italic', title_weight='bold', title_color='#00FF00', li_font='Courier New', li_color='#0000FF', li_completed_style='italic', li_completed_weight='bold', li_completed_color='#FFA500', li_completed_decoration='#00FF00')
    ...
    style_4 = ListStyle(list_id=4, image_url='https://i.ibb.co/DCDT1vN/ramen.jpg', title_font='Times New Roman', title_align='left', li_font='Trebuchet MS', li_style='italic', li_color='#FF0000', li_completed_decoration='#0000FF')
    ...
    style_7 = ListStyle(list_id=7, image_url='https://i.ibb.co/Ss4wWhx/snow.jpg', title_size='24pt', title_style='italic', title_color='#FFFFFF', li_size='14pt', li_color='#800080', li_completed_decoration='#800080')
    ...
    style_11 = ListStyle(list_id=11, image_url='https://i.ibb.co/sbTcxLX/city.jpg', title_style='italic', title_align='left')
    style_12 = ListStyle(list_id=12, image_url='https://i.ibb.co/x5JTcn3/wedding.jpg', title_font='Luminari', title_size='24pt', title_style='italic', title_align='left', li_font='Baskerville', li_size='18pt', li_completed_weight='bold', li_completed_decoration='#0000FF')
    style_13 = ListStyle(list_id=13, image_url='https://i.ibb.co/GPFK3qm/park.jpg', title_font='Times New Roman', title_size='18pt', title_weight='bold', title_color='#155729', li_font='American Typewriter', li_size='16pt', li_style='italic', li_color='#008F1A', li_completed_weight='bold', li_completed_color='#000000', li_completed_decoration='#155729')
    style_14 = ListStyle(list_id=14, image_url='https://i.ibb.co/rwf3LMZ/michelin.jpg', title_font='Didot', title_color='#507858', title_align='left', li_font='Georgia', li_color='#507858', li_completed_style='italic', li_completed_weight='bold', li_completed_decoration='#721287')
